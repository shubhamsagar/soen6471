...
.type1 {"src/main/webapp/WEB-INF/views/customer.jsp"
...
<body>
	...
	<center>
		<ul>
			<li>${customer.custFirstName}</li>
		</ul>
		<ul>
			<li>${customer.custLastName}</li>
		</ul>
		<table>
			<tr>
				<th>
					<form action="/CustomerRepresentativePortal/raiseTicket"
						...
						<input type="text" name="customerID" value="${customer.custId}"
							hidden required> <input type="submit" value="Raise Ticket">
					</form>
				</th>
				<th>
					<form action="/CustomerRepresentativePortal/exploreplans"
						method="get">
						<input type="text" name="customerID" value="${customer.custId}"
							hidden required> <input type="submit" value="Explore Plans">
					</form>
				</th>
				<th>
					<form
